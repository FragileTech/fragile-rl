...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: Holographic Coefficient; Levin Length
...
|---|---|---|---|---|
| E-001 | The Saturation Limit / Metric Divergence at Saturation (line 198) | Moderate | Scope restriction | Missing hypotheses in Metric Divergence at Saturation |
| E-002 | The Levin Length / Levin Length (line 149) | Moderate | External dependency | External dependency in Levin Length |

## Detailed findings

### [E-001] Missing hypotheses in Metric Divergence at Saturation
- Location: The Saturation Limit / Metric Divergence at Saturation (line 198)
- Severity: Moderate
- Type: Scope restriction (secondary: None)
- Claim (paraphrase): The statement labeled "Metric Divergence at Saturation" is presented as a general result without explicit domain/regularity assumptions in the theorem block.
...
### [E-002] External dependency in Levin Length
- Location: The Levin Length / Levin Length (line 149)
- Severity: Moderate
- Type: External dependency (secondary: None)
- Claim (paraphrase): The block "Levin Length" cites external sources within the formal statement, but does not provide an internal permit or derivation.
