...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: The Reward 1-Form; The Reward Flux (Boundary Form)
...
|---|---|---|---|---|
| E-001 | The Conservative Case: Scalar Potential and Screened Poisson Equation / The HJB-Helmholtz Correspondence {cite}`bellman1957dynamic,evans2010pde` (line 323) | Moderate | External dependency | External dependency in The HJB-Helmholtz Correspondence {cite}`bellman1957dynamic,evans2010pde` |

## Detailed findings

### [E-001] External dependency in The HJB-Helmholtz Correspondence {cite}`bellman1957dynamic,evans2010pde`
- Location: The Conservative Case: Scalar Potential and Screened Poisson Equation / The HJB-Helmholtz Correspondence {cite}`bellman1957dynamic,evans2010pde` (line 323)
- Severity: Moderate
- Type: External dependency (secondary: None)
- Claim (paraphrase): The block "The HJB-Helmholtz Correspondence {cite}`bellman1957dynamic,evans2010pde`" cites external sources within the formal statement, but does not provide an internal permit or derivation.
