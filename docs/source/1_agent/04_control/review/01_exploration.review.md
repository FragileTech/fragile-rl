...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: Macro Path Distribution; Causal Path Entropy
...
|---|---|---|---|---|
| E-001 | Intrinsic Motivation: Maximum-Entropy Exploration (line 2) | Note | Scope restriction | Summary claims lack explicit scope |

## Detailed findings

### [E-001] Summary claims lack explicit scope
- Location: Intrinsic Motivation: Maximum-Entropy Exploration (line 2)
- Severity: Note
