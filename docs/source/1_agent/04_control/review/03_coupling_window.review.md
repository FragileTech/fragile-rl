...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: Grounding rate; Mixing rate
...
|---|---|---|---|---|
| E-001 | Theorem: The Information-Stability Threshold (Coupling Window) / Information-stability window; operational (line 120) | Moderate | Scope restriction | Missing hypotheses in Information-stability window; operational |
| E-002 | Roadmap (line 43) | Minor | External dependency | External dependency in narrative claim |

## Detailed findings

### [E-001] Missing hypotheses in Information-stability window; operational
- Location: Theorem: The Information-Stability Threshold (Coupling Window) / Information-stability window; operational (line 120)
- Severity: Moderate
- Type: Scope restriction (secondary: None)
- Claim (paraphrase): The statement labeled "Information-stability window; operational" is presented as a general result without explicit domain/regularity assumptions in the theorem block.
