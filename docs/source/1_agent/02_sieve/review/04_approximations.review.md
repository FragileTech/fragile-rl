...
|---|---|---|---|---|
| E-001 | Infeasible Implementation Replacements (line 2) | Note | Scope restriction | Summary claims lack explicit scope |

## Detailed findings

### [E-001] Summary claims lack explicit scope
- Location: Infeasible Implementation Replacements (line 2)
- Severity: Note
