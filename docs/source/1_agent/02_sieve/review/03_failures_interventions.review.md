...
|---|---|---|---|---|
| E-001 | Failure Modes (Observed Pathologies) (line 2) | Note | Scope restriction | Summary claims lack explicit scope |

## Detailed findings

### [E-001] Summary claims lack explicit scope
- Location: Failure Modes (Observed Pathologies) (line 2)
- Severity: Note
