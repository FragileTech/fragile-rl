...
|---|---|---|---|---|
| E-001 | A. Single-Barrier Enforcement (Hard Constraints) (line 117) | Minor | External dependency | External dependency in narrative claim |

## Detailed findings

### [E-001] External dependency in narrative claim
- Location: A. Single-Barrier Enforcement (Hard Constraints) (line 117)
- Severity: Minor
