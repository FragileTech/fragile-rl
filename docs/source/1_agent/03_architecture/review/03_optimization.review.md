...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: Preconditioned Update; Relative Trust Region (Mach Limit)
...
|---|---|---|---|---|
| E-001 | Optimization: Thermodynamic Governor and Stable Updates (line 2) | Note | Scope restriction | Summary claims lack explicit scope |

## Detailed findings

### [E-001] Summary claims lack explicit scope
- Location: Optimization: Thermodynamic Governor and Stable Updates (line 2)
- Severity: Note
