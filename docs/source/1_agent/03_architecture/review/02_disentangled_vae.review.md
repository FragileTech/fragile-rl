...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: The Three-Channel Latent Decomposition; The Golden Rule of Causal Enclosure
...
|---|---|---|---|---|
| E-001 | TopoEncoder Architecture: Attentive Atlas with Typed Latents (line 3) | Note | Scope restriction | Summary claims lack explicit scope |

## Detailed findings

### [E-001] Summary claims lack explicit scope
- Location: TopoEncoder Architecture: Attentive Atlas with Typed Latents (line 3)
- Severity: Note
