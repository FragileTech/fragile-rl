...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: Attentive Routing Law; The Macro-State Tree
...
|---|---|---|---|---|
| E-001 | Tier 4: Riemannian Fragile Agent (Covariant Updates) (line 327) | Minor | External dependency | External dependency in narrative claim |

## Detailed findings

### [E-001] External dependency in narrative claim
- Location: Tier 4: Riemannian Fragile Agent (Covariant Updates) (line 327)
- Severity: Minor
