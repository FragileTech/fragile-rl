...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: DPI / boundary-capacity constraint; Information density and bulk information volume
...
|---|---|---|---|---|
| E-001 | Main Result (Capacity-Saturated Metric Law) / Capacity-constrained metric law (line 179) | Moderate | Scope restriction | Missing hypotheses in Capacity-constrained metric law |
| E-002 | Main Result (Capacity-Saturated Metric Law) (line 278) | Minor | External dependency | External dependency in narrative claim |

## Detailed findings

### [E-001] Missing hypotheses in Capacity-constrained metric law
- Location: Main Result (Capacity-Saturated Metric Law) / Capacity-constrained metric law (line 179)
- Severity: Moderate
- Type: Scope restriction (secondary: None)
- Claim (paraphrase): The statement labeled "Capacity-constrained metric law" is presented as a general result without explicit domain/regularity assumptions in the theorem block.
...
- Location: Main Result (Capacity-Saturated Metric Law) (line 278)
- Severity: Minor
