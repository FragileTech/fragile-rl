...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: Manifold Boundary and Interior; Hyperbolic Volume Growth
...
|---|---|---|---|---|
| E-001 | Policy Control Field / Unified Control Interpretation (line 299) | Moderate | External dependency | External dependency in Unified Control Interpretation |

## Detailed findings

### [E-001] External dependency in Unified Control Interpretation
- Location: Policy Control Field / Unified Control Interpretation (line 299)
- Severity: Moderate
- Type: External dependency (secondary: None)
- Claim (paraphrase): The block "Unified Control Interpretation" cites external sources within the formal statement, but does not provide an internal permit or derivation.
