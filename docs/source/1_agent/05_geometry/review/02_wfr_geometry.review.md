...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: The Generalized WFR Action; Canonical length-scale
...
|---|---|---|---|---|
| E-001 | Reconciling Discrete and Continuous / Limiting Regimes (line 296) | Moderate | Scope restriction | Missing hypotheses in Limiting Regimes |
| E-002 | Connection to GKSL / Master Equation ({ref}`Section 12.5 <sec-optional-operator-valued-belief-updates>`) / Classical Master Equation as WFR Gradient Flow (line 373) | Moderate | External dependency | External dependency in Classical Master Equation as WFR Gradient Flow |

## Detailed findings

### [E-001] Missing hypotheses in Limiting Regimes
- Location: Reconciling Discrete and Continuous / Limiting Regimes (line 296)
- Severity: Moderate
- Type: Scope restriction (secondary: None)
- Claim (paraphrase): The statement labeled "Limiting Regimes" is presented as a general result without explicit domain/regularity assumptions in the theorem block.
...
### [E-002] External dependency in Classical Master Equation as WFR Gradient Flow
- Location: Connection to GKSL / Master Equation ({ref}`Section 12.5 <sec-optional-operator-valued-belief-updates>`) / Classical Master Equation as WFR Gradient Flow (line 373)
- Severity: Moderate
- Type: External dependency (secondary: None)
- Claim (paraphrase): The block "Classical Master Equation as WFR Gradient Flow" cites external sources within the formal statement, but does not provide an internal permit or derivation.
