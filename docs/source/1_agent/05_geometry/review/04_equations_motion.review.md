...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: Mass Tensor; Extended Onsager-Machlup Action
...
|---|---|---|---|---|
| E-001 | The Stochastic Action Principle (Mass = Metric) / Mass Scaling Near Boundary (line 162) | Moderate | Scope restriction | Missing hypotheses in Mass Scaling Near Boundary |
| E-002 | The Stochastic Action Principle (Mass = Metric) / Most Probable Path (line 183) | Moderate | External dependency | External dependency in Most Probable Path |

## Detailed findings

### [E-001] Missing hypotheses in Mass Scaling Near Boundary
- Location: The Stochastic Action Principle (Mass = Metric) / Mass Scaling Near Boundary (line 162)
- Severity: Moderate
- Type: Scope restriction (secondary: None)
- Claim (paraphrase): The statement labeled "Mass Scaling Near Boundary" is presented as a general result without explicit domain/regularity assumptions in the theorem block.
...
### [E-002] External dependency in Most Probable Path
- Location: The Stochastic Action Principle (Mass = Metric) / Most Probable Path (line 183)
- Severity: Moderate
- Type: External dependency (secondary: None)
- Claim (paraphrase): The block "Most Probable Path" cites external sources within the formal statement, but does not provide an internal permit or derivation.
