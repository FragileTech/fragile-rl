# Mathematical Review: docs/source/1_agent/10_appendices/01_derivations.md

## Metadata
- Reviewed file: docs/source/1_agent/10_appendices/01_derivations.md
...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: A.1.1 (Boundary capacity form); A.1.2 (Boundary-capacity constraint functional)
...
|---|---|---|---|---|
| E-001 | A.6.0 Foundational Axioms for Microstate Counting / A.6.0b (Chentsov's Uniqueness Theorem) (line 579) | Moderate | External dependency | External dependency in A.6.0b (Chentsov's Uniqueness Theorem) |

## Detailed findings

### [E-001] External dependency in A.6.0b (Chentsov's Uniqueness Theorem)
- Location: A.6.0 Foundational Axioms for Microstate Counting / A.6.0b (Chentsov's Uniqueness Theorem) (line 579)
- Severity: Moderate
- Type: External dependency (secondary: None)
- Claim (paraphrase): The block "A.6.0b (Chentsov's Uniqueness Theorem)" cites external sources within the formal statement, but does not provide an internal permit or derivation.
