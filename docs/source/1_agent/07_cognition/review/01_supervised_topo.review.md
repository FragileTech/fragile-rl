...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: Semantic Partition; Class-Conditioned Potential
...
|---|---|---|---|---|
| E-001 | Relationship to the Context-Conditioned Framework / Soft Injectivity (line 99) | Moderate | External dependency | External dependency in Soft Injectivity |

## Detailed findings

### [E-001] External dependency in Soft Injectivity
- Location: Relationship to the Context-Conditioned Framework / Soft Injectivity (line 99)
- Severity: Moderate
- Type: External dependency (secondary: None)
- Claim (paraphrase): The block "Soft Injectivity" cites external sources within the formal statement, but does not provide an internal permit or derivation.
