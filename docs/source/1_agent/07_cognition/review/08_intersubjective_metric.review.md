...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: Metric Friction; The Inter-Agent Connection
...
|---|---|---|---|---|
| E-001 | Roadmap (line 50) | Minor | External dependency | External dependency in narrative claim |

## Detailed findings

### [E-001] External dependency in narrative claim
- Location: Roadmap (line 50)
- Severity: Minor
