...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: The Meta-Control Problem; Uncontrolled Dynamics
...
|---|---|---|---|---|
| E-001 | The Universal Governor / Subsumption of {ref}`sec-adaptive-multipliers-learned-penalties-setpoints-and-calibration` (line 235) | Moderate | Scope restriction | Missing hypotheses in Subsumption of {ref}`sec-adaptive-multipliers-learned-penalties-setpoints-and-calibration` |
| E-002 | Formalization of Learning Dynamics / Controlled Update Law (line 129) | Moderate | External dependency | External dependency in Controlled Update Law |

## Detailed findings

### [E-001] Missing hypotheses in Subsumption of {ref}`sec-adaptive-multipliers-learned-penalties-setpoints-and-calibration`
- Location: The Universal Governor / Subsumption of {ref}`sec-adaptive-multipliers-learned-penalties-setpoints-and-calibration` (line 235)
- Severity: Moderate
- Type: Scope restriction (secondary: None)
- Claim (paraphrase): The statement labeled "Subsumption of {ref}`sec-adaptive-multipliers-learned-penalties-setpoints-and-calibration`" is presented as a general result without explicit domain/regularity assumptions in the theorem block.
...
### [E-002] External dependency in Controlled Update Law
- Location: Formalization of Learning Dynamics / Controlled Update Law (line 129)
- Severity: Moderate
- Type: External dependency (secondary: None)
- Claim (paraphrase): The block "Controlled Update Law" cites external sources within the formal statement, but does not provide an internal permit or derivation.
