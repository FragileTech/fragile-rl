...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: The Interventional Surgery; Causal Information Potential
...
|---|---|---|---|---|
| E-001 | The Interventional Operator as Manifold Surgery / The Interventional Surgery (line 85) | Moderate | External dependency | External dependency in The Interventional Surgery |

## Detailed findings

### [E-001] External dependency in The Interventional Surgery
- Location: The Interventional Operator as Manifold Surgery / The Interventional Surgery (line 85)
- Severity: Moderate
- Type: External dependency (secondary: None)
- Claim (paraphrase): The block "The Interventional Surgery" cites external sources within the formal statement, but does not provide an internal permit or derivation.
