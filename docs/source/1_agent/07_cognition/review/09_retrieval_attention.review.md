# Mathematical Review: docs/source/1_agent/07_cognition/09_retrieval_attention.md

## Metadata
- Reviewed file: docs/source/1_agent/07_cognition/09_retrieval_attention.md
...
- Framework anchors (definitions/axioms/permits):
  ...
  - Local anchors: Memory Potential (Recap); Causal Information Potential (Recap)
...
|---|---|---|---|---|
| E-001 | Why Standard Self-Attention Fails for Memory / Failure Modes of Standard Self-Attention for Memory (line 74) | Moderate | Scope restriction | Missing hypotheses in Failure Modes of Standard Self-Attention for Memory |
| E-002 | Lorentzian Geometry for Memory (line 311) | Minor | External dependency | External dependency in narrative claim |

## Detailed findings

### [E-001] Missing hypotheses in Failure Modes of Standard Self-Attention for Memory
- Location: Why Standard Self-Attention Fails for Memory / Failure Modes of Standard Self-Attention for Memory (line 74)
- Severity: Moderate
- Type: Scope restriction (secondary: None)
- Claim (paraphrase): The statement labeled "Failure Modes of Standard Self-Attention for Memory" is presented as a general result without explicit domain/regularity assumptions in the theorem block.
...
- Location: Lorentzian Geometry for Memory (line 311)
- Severity: Minor
